  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!(await queryRunner.hasTable("variable"))) {
      ...
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('migrationVersion','1')  `
      );
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('migrationRange',0)  `
      );
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('currentBlockNo',57476589)  `
      );
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('currentEthBlockNo',12306758)  `
      );
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('totalStaking',0)  `
      );
      await queryRunner.query(
        `INSERT INTO variable(\`key\`,\`value\`) VALUES ('totalReward',0)  `
      );
    }
    ...
    if (!(await queryRunner.hasTable("nft_rank"))) {
      ...
      await queryRunner.query(
        `INSERT INTO nft_rank(\`tokenAddress\`) VALUES ('0x49E508C437AF1F0Cad0b52A31963A2cfF02cc666')  `
      );
    }
