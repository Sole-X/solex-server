...
export class newsletter1622189158104 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createIndex(newsletterTbl, new TableIndex({
          name: 'idx_email',
          columnNames: ['email']
        }));
        ...
        await queryRunner.createIndex(mailLogTbl, new TableIndex({
            name: 'idx_email',
            columnNames: ['email']
          }));
        ...
        await queryRunner.query(`INSERT INTO ${mailTemplateTbl}(\`subject\`,\`template\`) VALUES ('test','{param0}님 안녕하세요')  `);
